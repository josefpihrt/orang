...
|
        ...
        ref ImmutableArray<SpellingMatch>.Builder? builder)
    {
        ...
        else if (!Data.Contains(value))
        {
            ...
            do
            {
                AnalyzeWordPart(input, value[lastEnd..match.Index], lastEnd + index, value, index, ref builder);
            ...
            AnalyzeWordPart(input, value[lastEnd..], lastEnd + index, value, index, ref builder);
        }
    }
